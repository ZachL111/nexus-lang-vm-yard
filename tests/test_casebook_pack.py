"""Regression checks for the nexus-lang-vm-yard casebook."""
...
from casebook.harness import assert_expected, nexus_lang_vm_yard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(nexus_lang_vm_yard_summary(), assert_expected())
